...
import org.springframework.security.config.oauth2.client.CommonOAuth2Provider;//added dependency
...
// PRE 0
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .httpBasic().and()
                .authorizeRequests()   //ПОЛУЧАЕТСЯ, ОН РАЗРЕШАЕТ ВСЁ КРОМЕ ТГО ЧТО ПРОПИСАНО ЗДЕСЬ!?!??!?!!
